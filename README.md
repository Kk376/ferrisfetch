...
**Via Pre-built `.deb`:**
```bash
curl -LO https://github.com/kk376/ferrisfetch/releases/download/v0.9.6/ferrisfetch_0.9.6-1_amd64.deb
sudo dpkg -i ferrisfetch_0.9.6-1_amd64.deb
```
...
```bash
curl -LO https://github.com/kk376/ferrisfetch/releases/download/v0.9.6/ferrisfetch-0.9.6-1-x86_64.pkg.tar.zst
sudo pacman -U ferrisfetch-0.9.6-1-x86_64.pkg.tar.zst
```
...
```bash
curl -LO https://github.com/kk376/ferrisfetch/releases/download/v0.9.6/ferrisfetch_0.9.6-1_termux_aarch64.deb
dpkg -i ferrisfetch_0.9.6-1_termux_aarch64.deb
```
...
```powershell
# 1. Download
curl.exe -LO https://github.com/kk376/ferrisfetch/releases/download/v0.9.6/ferrisfetch-windows-x86_64.zip
...
```bash
curl -LO https://github.com/kk376/ferrisfetch/releases/download/v0.9.6/ferrisfetch-linux-musl-x86_64
...
* **Gentoo Linux**: [`packaging/gentoo/`](packaging/gentoo/) (`ferrisfetch-0.9.6.ebuild`)
